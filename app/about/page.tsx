      ...
      <div className="w-full max-w-md mx-auto px-4 py-3">
        ...
        >
          ...
          <div className="mt-2 space-y-8">
            ...
            <GlyphSeparator
              glyphId={16}
              fgColorIndices={[12, 13, 14]}
              bgColorIndices={[6, 7, 8]}
            />
            <div className="mt-4">
            ...
            <GlyphSeparator
              glyphId={31}
              fgColorIndices={[18, 19, 20]}
              bgColorIndices={[9, 10, 11]}
            />
            <div className="mt-4">
            ...
            <GlyphSeparator
              glyphId={57}
              fgColorIndices={[0, 1, 2]}
              bgColorIndices={[15, 16, 17]}
            />
            <div className="mt-4">
            ...
            <GlyphSeparator
              glyphId={21}
              fgColorIndices={[24, 25, 26]}
              bgColorIndices={[3, 4, 5]}
            />
            <div className="mt-4">
